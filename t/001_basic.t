...
use lib qw(/Users/stevan/Projects/BES-2010/BES_2010/lib /Users/stevan/Projects/EERS-Offline/EERS-Offline/trunk/lib /Users/stevan/Projects/BES-v2/BES-Company/lib/ /Users/stevan/Projects/CPAN/current/__in_dev/FeyX-Active/lib/);
...
my $n = KiokuDB::Navigator->new(
    db       => KiokuDB->connect("dbi:mysql:database=canada_bes;", user => 'canada_bes', password => 'canada_bes.^789'),
    doc_root => [ $FindBin::Bin, '..', 'doc_root' ],
    root_id  => '203000000000000000',
);
